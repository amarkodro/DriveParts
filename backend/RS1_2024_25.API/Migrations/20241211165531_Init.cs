    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, "High-quality brake pads for Golf", 1, "Brake Pads", 85.0 },
                    { 2, 2, 2, "Durable suspension springs for Q5", 2, "Suspension Springs", 220.0 },
                    { 3, 3, 6, "Oil filter suitable for Clio engines", 3, "Engine Oil Filter", 25.0 },
                    { 4, 4, 4, "Rust-resistant exhaust pipe for 508", 4, "Exhaust Pipe", 300.0 },
                    { 5, 5, 8, "High-performance coolant hose for Panda", 5, "Coolant Hose", 40.0 },
                    { 6, 1, 6, "Improves air intake efficiency for Golf", 6, "Air Filter", 35.0 },
                    { 7, 2, 2, "Enhanced suspension system for Q5", 7, "Shock Absorber", 250.0 },
                    { 8, 3, 7, "High-performance spark plugs for Clio", 8, "Spark Plugs", 50.0 },
                    { 9, 4, 4, "Eco-friendly exhaust component for 508", 1, "Catalytic Converter", 450.0 },
                    { 10, 5, 5, "Premium oil for Panda engines", 2, "Engine Oil", 90.0 },
                    { 11, 1, 1, "Front brake discs for Golf", 3, "Brake Discs", 150.0 },
                    { 12, 2, 2, "Steering system component for Q5", 4, "Tie Rod Ends", 180.0 },
                    { 13, 3, 3, "Efficient fuel pump for Clio", 5, "Fuel Pump", 220.0 },
                    { 14, 4, 3, "Boost engine power for 508", 6, "Turbocharger", 1000.0 },
                    { 15, 5, 9, "All-weather wipers for Panda", 7, "Windshield Wipers", 25.0 },
                    { 16, 1, 8, "High-efficiency radiator for Golf", 8, "Radiator", 300.0 },
                    { 17, 2, 2, "Stable suspension arms for Q5", 1, "Control Arms", 350.0 },
                    { 18, 3, 7, "Reliable ignition coil for Clio", 2, "Ignition Coil", 75.0 },
                    { 19, 4, 9, "Bright and durable headlights for 508", 3, "Headlight Assembly", 400.0 },
                    { 20, 5, 7, "Long-lasting battery for Panda", 4, "Battery", 180.0 }
                });
