...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RS1_2024_25.API.Data.Models.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RS1_2024_25.API.Data.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RS1_2024_25.API.Data.Models.MyPart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RS1_2024_25.API.Data.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RS1_2024_25.API.Data.Models.Message", b =>
                {
                    b.HasOne("RS1_2024_25.API.Data.Models.Conversation", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("RS1_2024_25.API.Data.Models.UserAccount", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("RS1_2024_25.API.Data.Models.MyPart", b =>
                {
                    ...
                    b.HasOne("RS1_2024_25.API.Data.Models.UserAccount", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("RS1_2024_25.API.Data.Models.RefreshToken", b =>
                {
                    b.HasOne("RS1_2024_25.API.Data.Models.UserAccount", "UserAccount")
                        .WithMany()
