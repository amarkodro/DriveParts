    ...
    partial class DataSeeder
    {
        public void DataSeed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<City>().HasData(
                   new City { ID = 1, Name = "Banja Luka", CountryId = 1, PostalCode = 78000 },
                   new City { ID = 2, Name = "Bihać", CountryId = 1, PostalCode = 77000 },
                   new City { ID = 3, Name = "Bijeljina", CountryId = 1, PostalCode = 76300 },
                   new City { ID = 4, Name = "Bosanska Krupa", CountryId = 1, PostalCode = 77240 },
                   new City { ID = 5, Name = "Cazin", CountryId = 1, PostalCode = 77220 },
                   new City { ID = 6, Name = "Čapljina", CountryId = 1, PostalCode = 88300 },
                   new City { ID = 7, Name = "Derventa", CountryId = 1, PostalCode = 74400 },
                   new City { ID = 8, Name = "Doboj", CountryId = 1, PostalCode = 74000 },
                   new City { ID = 9, Name = "Goražde", CountryId = 1, PostalCode = 73000 },
                   new City { ID = 10, Name = "Gračanica", CountryId = 1, PostalCode = 75320 },
                   new City { ID = 11, Name = "Konjic", CountryId = 1, PostalCode = 88400 },
                   new City { ID = 12, Name = "Laktaši", CountryId = 1, PostalCode = 78250 },
                   new City { ID = 13, Name = "Livno", CountryId = 1, PostalCode = 80101 },
                   new City { ID = 14, Name = "Lukavac", CountryId = 1, PostalCode = 75300 },
                   new City { ID = 15, Name = "Ljubuški", CountryId = 1, PostalCode = 88320 },
                   new City { ID = 16, Name = "Mostar", CountryId = 1, PostalCode = 88000 },
                   new City { ID = 17, Name = "Orašje", CountryId = 1, PostalCode = 76270 },
                   new City { ID = 18, Name = "Prijedor", CountryId = 1, PostalCode = 79101 },
                   new City { ID = 19, Name = "Prnjavor", CountryId = 1, PostalCode = 78430 },
                   new City { ID = 20, Name = "Sarajevo", CountryId = 1, PostalCode = 71000 },
                   new City { ID = 21, Name = "Srebrenik", CountryId = 1, PostalCode = 75350 },
                   new City { ID = 22, Name = "Stolac", CountryId = 1, PostalCode = 88360 },
                   new City { ID = 23, Name = "Široki Brijeg", CountryId = 1, PostalCode = 88220 },
                   new City { ID = 24, Name = "Travnik", CountryId = 1, PostalCode = 72270 },
                   new City { ID = 25, Name = "Tuzla", CountryId = 1, PostalCode = 75000 },
                   new City { ID = 26, Name = "Visoko", CountryId = 1, PostalCode = 71300 },
                   new City { ID = 27, Name = "Zavidovići", CountryId = 1, PostalCode = 72220 },
                   new City { ID = 28, Name = "Zenica", CountryId = 1, PostalCode = 72000 },
                   new City { ID = 29, Name = "Zvornik", CountryId = 1, PostalCode = 75400 },
                   new City { ID = 30, Name = "Živinice", CountryId = 1, PostalCode = 75270 },
                   new City { ID = 31, Name = "Donji Vakuf", CountryId = 1, PostalCode = 70220 }
             );
